        ...
        <div className="max-w-3xl px-8 py-8 flex flex-col gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-5">
                    <div className="w-20 h-20 rounded-full bg-gray-100 border-2 border-gray-200 flex items-center justify-center shrink-0 overflow-hidden">
                    ...
                    <div>
                        ...
                        <h1 className="text-3xl font-extrabold text-gray-900 leading-tight">{displayName}</h1>
                    </div>
                </div>
                    ...
                    <>
                        ...
                        <div className="col-span-2 flex gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                            ...
                            <p className="text-xs text-amber-700 leading-relaxed">
                                <span className="font-semibold">CAC Verification</span> — Automated CAC verification
                                is currently beyond our scope. Our team will manually verify your hospital registration details.
                            </p>
                        </div>
                        {profile.verified && (
